...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new AiWorkEngineClient()" to fix this error.`)
    }
    return instance
  }
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the AiWork system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the AiWork system.
   */
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global AiWork configuration settings and preferences.
   */
   ...
   *
   * Update global AiWork configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the AiWork server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the AiWork system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all AiWork instances, releasing all resources.
   */
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current AiWork configuration settings and preferences.
   */
   ...
   *
   * Update AiWork configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Console extends HeyApiClient {
   ...
   *
   * Persist a new active Console account/org selection for the current local AiWork state.
   */
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current AiWork instance, releasing all resources.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the AiWork system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with AiWork.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get current project
   *
   * Retrieve the currently active project that AiWork is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by AiWork.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all AiWork sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new AiWork session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific AiWork session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class AiWorkEngineClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<AiWorkEngineClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    AiWorkEngineClient.__registry.set(this, args?.key)
  }
