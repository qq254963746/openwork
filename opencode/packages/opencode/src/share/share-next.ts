import type * as SDK from "@aiwork-engine/sdk/v2"
...
const disabled = process.env["AIWORK_ENGINE_DISABLE_SHARE"] === "true" || process.env["AIWORK_ENGINE_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@aiwork-engine/ShareNext") {}
