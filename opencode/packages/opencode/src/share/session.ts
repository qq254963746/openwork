...
export class Service extends Context.Service<Service, Interface>()("@aiwork-engine/SessionShare") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("SessionShare.create")(function* (input?: Session.CreateInput) {
      ...
      const conf = yield* cfg.get()
      if (!(Flag.AIWORK_ENGINE_AUTO_SHARE || conf.share === "auto")) return result
