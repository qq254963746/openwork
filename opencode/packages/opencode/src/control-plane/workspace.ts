...
export class Service extends Context.Service<Service, Interface>()("@aiwork-engine/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const startSync = Effect.fn("Workspace.startSync")(function* (space: Info) {
      if (!Flag.AIWORK_ENGINE_EXPERIMENTAL_WORKSPACES) return
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        AIWORK_ENGINE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        AIWORK_ENGINE_WORKSPACE_ID: config.id,
        AIWORK_ENGINE_EXPERIMENTAL_WORKSPACES: "true",
