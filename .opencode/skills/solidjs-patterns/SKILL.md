...
description: SolidJS reactivity + UI state patterns for AiWork
---

## Why this skill exists

AiWork’s UI is SolidJS: it updates via **signals**, not React-style rerenders.
...
This skill captures the patterns we want to consistently use in AiWork.
