...
description: Bridge between AiWork UI and OpenCode runtime
---

## Overview

AiWork communicates with OpenCode via three mechanisms:
...
AiWork can register as an MCP server that OpenCode connects to.
...
### Use cases
- Real-time permission prompts surfaced in AiWork UI.
- Streaming progress updates.
- Custom tools exposed from AiWork (e.g., native file picker).
