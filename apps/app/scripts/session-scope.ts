...
const starterRoot = "/Users/test/AiWork/starter";
const otherRoot = "/Users/test/AiWork/second";
...
try {
  ...
  await step("windows create and list use the same transport directory", () => {
    ...
    const winRoot = String.raw`C:\Users\Test\AiWork\starter`;
    ...
    const verbatimDriveRoot = String.raw`\\?\C:\Users\Test\AiWork\starter`;
    assert.equal(toSessionTransportDirectory(verbatimDriveRoot), String.raw`C:\Users\Test\AiWork\starter`);
    assert.equal(describeDirectoryScope(verbatimDriveRoot).normalized, "c:/users/test/aiwork/starter");
  });
