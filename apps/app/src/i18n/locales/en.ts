...
export default {
  ...
  "extensions.plugins_opencode_header": "Plugins (AiWork)",
  ...
  "settings.diag_opencode_binary": "AiWork binary: {binary}",
  ...
  "settings.opencode_cache": "AiWork cache",
  ...
  "settings.opencode_engine_label": "AiWork engine",
  "settings.opencode_engine_sidecar": "AiWork engine",
  "settings.opencode_engine_sidecar_desc": "Local AiWork process managed by AiWork.",
  "settings.opencode_sdk_desc": "Browser → engine connection.",
  "settings.opencode_sdk_title": "AiWork SDK link",
  ...
  "settings.restart_opencode": "Restart AiWork",
