...
export default {
  ...
  "config.server_sharing_menu_hint": "These details apply to the OpenWork server on this machine. Enable remote access to copy worker URLs and tokens.",
  ...
  "session.app_log_unavailable": "Log collector unavailable.",
  ...
  "session.app_log_services_desktop_only": "OpenWork server and OpenCode engine logs are only available in the desktop app.",
  ...
  "session.context_lines": "lines",
  "session.context_mentions": "@mentions",
  "session.context_pastes": "Pasted snippets",
  ...
  "session.workspace_panel_svg_opened_browser":
    "Launched the file URL in your default application (usually the browser for SVG).",
