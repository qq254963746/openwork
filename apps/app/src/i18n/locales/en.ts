...
export default {
  ...
  "plugins.desc": "Manage `opencode.json` for your project or global AiWork plugins.",
  ...
  "providers.global_aiwork_json_failed":
    "Could not write global AiWork config (~/.config/opencode/opencode.json). Check permissions or AiWork server config access.",
  "providers.global_aiwork_json_invalid": "Global opencode.json is invalid JSON; fix it before saving provider settings.",
  ...
  "settings.aiwork_engine_label": "AiWork engine",
  "settings.aiwork_engine_sidecar": "AiWork engine",
  "settings.aiwork_engine_sidecar_desc": "Local AiWork process managed by AiWork.",
  ...
  "settings.reset_aiwork_desc_dev": "With dev mode active, it only clears the isolated AiWork dev state inside aiwork-engine.",
  "settings.reset_aiwork_desc_prod": "With dev mode active, it only clears the isolated AiWork dev state inside aiwork-engine.",
  ...
  "settings.environment.footer_hint": "AIWORK_ and AIWORK_ENGINE_ keys are reserved for app/runtime wiring. Configure AiWork runtime settings from your shell.",
  ...
  "settings.environment.validation_reserved": "AIWORK_ and AIWORK_ENGINE_ names are managed by AiWork/AiWork.",
  ...
  "skills.failed_load_aiwork": "Failed to load opencode.json",
  "skills.failed_parse_aiwork": "Failed to parse opencode.json",
  "skills.failed_to_load": "Failed to load skills",
  "skills.failed_update_aiwork": "Failed to update opencode.json",
  ...
  "skills.no_aiwork_found": "No opencode.json found yet. Add a plugin to create one.",
  "skills.no_aiwork_workspace": "No opencode.json in this workspace yet.",
  "skills.no_skills": "No skills detected in `.opencode/skills`.",
  ...
  "system.reload_body_config": "AiWork reads opencode.json at startup. Reload the engine to apply configuration changes.",
  ...
  "system.reload_body_plugins": "AiWork loads npm plugins at startup. Reload the engine to apply opencode.json changes.",
