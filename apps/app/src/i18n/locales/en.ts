...
export default {
  ...
  "config.server_sharing_desc": "Share these details with a trusted device on your network.",
  "config.server_sharing_menu_hint": "These details apply to the AiWork server on this machine.",
