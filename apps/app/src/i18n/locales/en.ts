...
export default {
  ...
  "settings.reset_aiwork_desc_dev": "With dev mode active, it only clears the isolated OpenCode dev state inside aiwork-engine.",
  "settings.reset_aiwork_desc_prod": "With dev mode active, it only clears the isolated OpenCode dev state inside aiwork-engine.",
