 ...
 * Professional terms (Skills, Plugins, Commands, Sessions, OpenCode, OpenPackage, AiWork) are NOT translated
 */
...
export default {
  ...
  "app.plugins_hint_readonly": "AiWork server is read-only for plugins.",
  "app.reload_later": "Later",
  "app.reload_now": "Reload now",
  "app.reload_stop_tasks": "Reload & Stop Tasks",
  "app.skills_hint_readonly": "AiWork server is read-only for skills. Add a host token in Advanced to enable installs.",
  ...
  "config.remote_access_off_hint": "Remote access is off. Enable it in Settings → Config before connecting from another machine.",
  "config.resolved_worker_url": "Resolved worker URL:",
  "config.server_needed_hint": "AiWork server connection needed to sync skills, plugins, and commands.",
  "config.server_section_desc": "Connect to an AiWork server. Use the URL plus a collaborator or owner token from your server admin.",
  "config.server_section_title": "AiWork server",
  ...
  "config.server_sharing_menu_hint": "These details apply to the AiWork server on this machine. Enable remote access to copy worker URLs and tokens.",
  "config.server_sharing_title": "AiWork server sharing",
  "config.server_url_hint": "Use the URL shared by your AiWork server. Local desktop workers reuse a persistent high port in the 48000-51000 range.",
  "config.server_url_input_label": "AiWork server URL",
  "config.server_url_label": "AiWork Server URL",
  ...
  "dashboard.create_remote_workspace_subtitle": "Save an AiWork server as a workspace.",
  ...
  "dashboard.edit_remote_workspace_subtitle": "Update the AiWork server details for this workspace.",
  ...
  "identities.connect_server_desc": "Identities are available when you are connected to an AiWork host.",
  "identities.connect_server_title": "Connect to an AiWork server",
  ...
  "identities.reconnect_failed": "Reconnect failed. Check AiWork URL/token and try again.",
  ...
  "mcp.auth.reload_remote_confirm": "For this to take effect, AiWork needs to refresh the worker service. This might stop your running session. Continue?",
  ...
  "session.workspace_panel_refresh": "Refresh file list",
  ...
  "session.workspace_panel_preview_unsupported": "Preview supports common text and Markdown files only.",
  ...
  "settings.custom_binary_hint": "Use this to point AiWork at a local OpenCode build",
  ...
  "settings.opencode_engine_sidecar_desc": "Local OpenCode process managed by AiWork.",
  ...
  "settings.aiwork_config_sidecar_desc": "Local AiWork server (Bun) that hosts approvals, audit, and OpenCode lifecycle.",
  ...
  "settings.reset_aiwork_desc_dev": "With dev mode active, it only clears the isolated OpenCode dev state inside aiwork-dev-data.",
  "settings.reset_aiwork_desc_prod": "With dev mode active, it only clears the isolated OpenCode dev state inside aiwork-dev-data.",
  "settings.reset_aiwork_title": "Reset AiWork + OpenCode state",
  ...
  "settings.environment.footer_hint": "AIWORK_ and OPENCODE_ keys are reserved for app/runtime wiring. Configure OpenCode runtime settings from your shell.",
  ...
  "settings.environment.validation_reserved": "AIWORK_ and OPENCODE_ names are managed by AiWork/OpenCode.",
  ...
  "system.reload_body_default": "AiWork detected changes that require reloading the OpenCode instance.",
  "system.reload_body_mcp": "OpenCode loads MCP servers at startup. Reload the engine to activate the new connection.",
  "system.reload_body_mixed": "AiWork detected OpenCode configuration changes. Reload the engine to apply them.",
  ...
  "workspace_list.remote_worker_unavailable_hint": "AiWork can't load tasks from this worker until the connection is fixed.",
