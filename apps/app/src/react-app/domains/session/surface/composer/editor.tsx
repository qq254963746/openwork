    ...
    const unregisterBackspace = editor.registerCommand(
      ...
      () => {
        ...
        if ($isElementNode(anchorNode)) {
          ...
          if (previous instanceof ComposerSlashCommandNode || previous instanceof ComposerMentionNode) {
            previous.remove();
            return true;
          }
        }
  ...
  return (
    <LexicalComposer initialConfig={initialConfig}>
      {/*
        ...
        - min-h matches one line (leading-6) until content wraps or grows.
      ...
      */}
      <div className="relative">
        <PlainTextPlugin
          contentEditable={
            <ContentEditable
              className="min-h-6 max-h-[280px] w-full resize-none overflow-y-auto bg-transparent text-[15px] leading-6 text-dls-text outline-none placeholder:text-dls-secondary [&_p]:min-h-[1.5rem] [&_p]:m-0"
