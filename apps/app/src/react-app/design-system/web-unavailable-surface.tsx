...
const MESSAGE =
  "This feature is currently unavailable in AiWork Web, check AiWork Desktop for full functionality.";
      ...
      {props.unavailable ? (
        ...
        >
          <div className="flex flex-wrap items-center gap-x-2 gap-y-1">
            <span>{MESSAGE}</span>
            <a
              href="https://aiworklabs.com"
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-1 underline underline-offset-2 hover:no-underline"
            >
              <span>Download AiWork Desktop</span>
