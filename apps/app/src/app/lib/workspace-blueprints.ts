...
export function blueprintSessions(config: WorkspaceAiWorkConfig | null | undefined): WorkspaceBlueprintSessionTemplate[] {
...
export function blueprintMaterializedSessions(config: WorkspaceAiWorkConfig | null | undefined): WorkspaceBlueprintMaterializedSession[] {
...
export function normalizeWorkspaceAiWorkConfig(
  value: unknown,
  preset?: string | null,
): WorkspaceAiWorkConfig {
  const candidate =
    value && typeof value === "object"
      ? (value as Partial<WorkspaceAiWorkConfig>)
      : {};
