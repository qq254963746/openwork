...
Try browser automation in AiWork right away.
...
- Instead, tell the user the shortest exact steps to connect `Control Chrome` from AiWork's MCP tab, then ask them to retry.
