...
// them into every spawned child (Engine, AiWork server).
...
// is for service credentials, not AiWork/Engine runtime knobs; users who
// need ENGINE_* process settings should set them from the launching shell.
