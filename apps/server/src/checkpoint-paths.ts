 ...
 *      macOS:  ~/Library/Application Support/com.aiworklove.aiwork/checkpoints/
 *      Linux:  $XDG_DATA_HOME/com.aiworklove.aiwork/checkpoints/
 *               (defaults to ~/.local/share/com.aiworklove.aiwork/checkpoints/)
 *      Win:    %APPDATA%/com.aiworklove.aiwork/checkpoints/
 *
 * Per-session layout:
...
const FALLBACK_BUNDLE_ID = "com.aiworklove.aiwork";
