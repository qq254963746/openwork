...
const binaryName = process.platform === "win32" ? "aiwork-server.exe" : "aiwork-server";
...
console.error(
  `Unable to find an AiWork server entrypoint in ${basename(packageRoot)}. Build the package or run it from a source checkout with Bun available.`,
);
process.exit(1);
