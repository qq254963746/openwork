...
OPENCODE_ROUTER_REPO="${OPENCODE_ROUTER_REPO:-https://github.com/qq254963746/openwork.git}"
...
Environment variables:
  ...
  OPENCODE_ROUTER_REPO         Git repo (default: https://github.com/qq254963746/openwork.git)
...
Example:
  OPENCODE_ROUTER_INSTALL_DIR=~/opencode-router curl -fsSL https://raw.githubusercontent.com/qq254963746/openwork/dev/apps/opencode-router/install.sh | bash
EOF
}
