...
OPENCODE_ROUTER_REPO="${OPENCODE_ROUTER_REPO:-https://github.com/qq254963746/aiwork.git}"
OPENCODE_ROUTER_INSTALL_DIR="${OPENCODE_ROUTER_INSTALL_DIR:-$HOME/.aiwork/opencode-router/aiwork}"
...
Environment variables:
  OPENCODE_ROUTER_INSTALL_DIR  Install directory (default: ~/.aiwork/opencode-router/aiwork)
  OPENCODE_ROUTER_REPO         Git repo (default: https://github.com/qq254963746/aiwork.git)
...
Example:
  OPENCODE_ROUTER_INSTALL_DIR=~/opencode-router curl -fsSL https://raw.githubusercontent.com/qq254963746/aiwork/dev/apps/opencode-router/install.sh | bash
EOF
}
