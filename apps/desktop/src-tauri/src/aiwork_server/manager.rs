...
pub struct AiWorkServerState {
    ...
    pub managed_aiwork_bin_path: Option<String>,
    pub managed_aiwork_bin_source: Option<String>,
...
impl AiWorkServerManager {
    pub fn snapshot_locked(state: &mut AiWorkServerState) -> AiWorkServerInfo {
        ...
        AiWorkServerInfo {
            ...
            managed_aiwork_bin_path: state.managed_aiwork_bin_path.clone(),
            managed_aiwork_bin_source: state.managed_aiwork_bin_source.clone(),
            pid,
    ...
    pub fn stop_locked(state: &mut AiWorkServerState) {
        ...
        state.managed_aiwork_bin_path = None;
        state.managed_aiwork_bin_source = None;
