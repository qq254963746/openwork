import type * as SDK from "@engine/sdk/v2"
...
const disabled = process.env["ENGINE_DISABLE_SHARE"] === "true" || process.env["ENGINE_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@engine/ShareNext") {}
