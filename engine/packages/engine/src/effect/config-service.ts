 ...
 *   "@engine/ServerAuthConfig",
 *   {
 *     password: Config.string("ENGINE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("ENGINE_SERVER_USERNAME").pipe(Config.withDefault("engine")),
 *   },
 * ) {}
 *
