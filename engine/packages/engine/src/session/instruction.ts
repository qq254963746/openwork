...
const FILES = [
  "AGENTS.md",
  ...(Flag.ENGINE_DISABLE_CLAUDE_CODE_PROMPT ? [] : ["CLAUDE.md"]),
...
export class Service extends Context.Service<Service, Interface>()("@engine/Instruction") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const globalFiles = [
      ...
      ...(!Flag.ENGINE_DISABLE_CLAUDE_CODE_PROMPT ? [path.join(global.home, ".claude", "CLAUDE.md")] : []),
    ]
