...
>()("@engine/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@engine/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceID | undefined {
  return Flag.ENGINE_WORKSPACE_ID ? WorkspaceID.make(Flag.ENGINE_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-engine-directory"] || process.cwd()
}
