...
export const RootHttpApi = HttpApi.make("engine-root").addHttpApi(ControlApi).addHttpApi(GlobalApi)

export const InstanceHttpApi = HttpApi.make("engine-instance")
...
export const AiWorkHttpApi = HttpApi.make("engine")
