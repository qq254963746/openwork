...
import { Bus } from "@/bus"
import { Notification } from "@/bus/notification"
...
export class Service extends Context.Service<Service, Interface>()("@engine/MCP") {}
    ...
    const connectTransport = (transport: Transport, timeout: number) =>
      Effect.acquireUseRelease(
        ...
        (t) =>
          Effect.tryPromise({
            try: () => {
              const client = new Client({ name: "engine", version: EngineVersion })
