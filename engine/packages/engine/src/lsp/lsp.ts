...
const filterExperimentalServers = (servers: Record<string, LSPServer.Info>) => {
  if (Flag.ENGINE_EXPERIMENTAL_LSP_TY) {
    if (servers["pyright"]) {
      log.info("LSP server pyright is disabled because ENGINE_EXPERIMENTAL_LSP_TY is enabled")
...
export class Service extends Context.Service<Service, Interface>()("@engine/LSP") {}
