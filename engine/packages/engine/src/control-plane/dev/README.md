This is a plugin to simulate a remote environment locally. Add this to `.engine/engine.jsonc`:

```json
  "plugin": ["../packages/engine/src/control-plane/dev/debug-workspace-plugin.ts"],
```
