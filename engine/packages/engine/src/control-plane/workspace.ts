...
export class Service extends Context.Service<Service, Interface>()("@engine/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const startSync = Effect.fn("Workspace.startSync")(function* (space: Info) {
      if (!Flag.ENGINE_EXPERIMENTAL_WORKSPACES) return
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        ENGINE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        ENGINE_WORKSPACE_ID: config.id,
        ENGINE_EXPERIMENTAL_WORKSPACES: "true",
