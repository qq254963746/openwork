...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new EngineClient()" to fix this error.`)
    }
    return instance
  }
...
export class EngineClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<EngineClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    EngineClient.__registry.set(this, args?.key)
  }
